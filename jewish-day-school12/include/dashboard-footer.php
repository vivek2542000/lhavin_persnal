<!----------------Assign /reassign-----modal Start------------->
<div class="modal" id="assign-pdf">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
              ...
              <label>Select Main Pdf</label>
              <select placeholder=" " id="single" class="js-states form-control" style="width: 100%;">
                <option>Pdf1</option>
                <option>Pdf2</option>
                <option>Pdf3</option>
              </select>
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="multiple-checkboxes" multiple="multiple" style="width: 100%;">
                <option>Rahul</option>
                <option>Mohan</option>
                <option>Sonu</option>
              </select>
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-12 text-center">
              <button class="main-btn">Assign</button>
            </div>
          </div>
        </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!--------------------Delete Message Modal Ends---------------->
         <!------------Delete messege Modal Popup Start------->
<div class="modal fade in sp-map" id="edit-popup">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
          <h4 class="modal-title">PDF Annotator Tool</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true" style="font-size: 32px;">×</span>
          </button>
