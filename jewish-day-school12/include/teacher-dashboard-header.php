...
<div id="wrapper">
  ...
  <aside id="sidebar-wrapper" class="shadow1">
    ...
    <ul class="sidebar-nav">
      <li class="active">
        <a href="teacher-dashboard.php"><i class="fa fa-dashboard"></i>Dashboard</a>
      </li>
      <li>
    <a href="edit-profile.php"><i class="fa fa-user"></i>Edit Profile</a></li>
    <li><a href="change-password.php"><i class="fa fa-key"></i> Change Password</a>
      </li>
       <li>
        <a href="assigned-by-admin.php"><i class="fa fa-file-pdf-o"></i>Assigned by Admin</a>
      </li>
      <li>
        <a href="assigned-to-student.php"><i class="fa fa-file-pdf-o"></i>Assigned to Student</a>
      </li>

       <li>
        <a href="students.php"><i class="fa fa-users"></i>My Student</a>
      </li>
    ...
    <div class="dropdown-menu">
       <ul  id="web-notification" class="notification-lsit">
                  ...
                  <a href="#">
                    ...
                    <span style=" color: #3CAE24;">A pdf has assigned to you by Admin</span>
                    </div>
                    </div>
                    </a>
                    </li>
                  ...
                  <a href="#">
                    ...
                    <span style=" color: #3CAE24;">A Student has complete a PDF.</span>
                    </div>
                    </div>
                    </a>
                    </li>
                  ...
                  <a href="#">
                    ...
                    <span style=" color: #3CAE24;">You assigned a pdf to Student name</span>
                    </div>
                    </div>
                    </a>
                    </li>
