  ...
  <nav class="navbar navbar-expand-sm d-flex justify-content-between">
    ...
    <div class="navbar-icon-div">
      <ul>
        ...
        <li><button class="head-btn"><a href="login.php">Login</a></button></li>
      <!--   <li><button class="head-btn"><a href="sign-up.php">SignUp</a></button></li> -->
        <li><a href="#" class="head-btn dropdown-toggle" data-toggle="dropdown">Sign Up<b class="caret"></b></a></button>
              <ul class="dropdown-menu multi-level">
                <li><a href="teacher-sign-up.php">As Teacher</a>
                        </li>
                        <li><a href="student-sign-up.php">As Student</a>
                        </li>
              </ul>
            </li>
      </ul>
