...
<head>
  ...
  <title>Jewish Day School|Login</title>
      ...
      <div class="col-md-5 sign-up-form">
        <form>
           <div class="logo text-center">
            ...
            <a href="" class="link-btn" data-toggle="modal" data-target="#forgot-password">Forgot Password</a>
          </div>
                  <div class="col-md-12 text-center mt-20">
                    <button class="main-btn"><a href="#">Login</a></button>
                  </div>
                  <div class="row mt-40">
            <div class="col-md-7"> <span class="all-acc">No account yet?</span> <a href="#" class="link-btn dropdown-toggle" data-toggle="dropdown">Sign Up<b class="caret"></b></a></button>
